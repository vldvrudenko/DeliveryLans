...
function globalBtn() {
    const globalType = document.getElementById("globalText");
    globalType.classList.remove("d-none");
    const globalBtn = document.getElementById("globalBtn");
    globalBtn.classList.add("cardDopColor");

    const visionType = document.getElementById("visionText");
    visionType.classList.add("d-none");
    const visionBtn = document.getElementById("visionBtn");
    visionBtn.classList.remove("cardDopColor");

    const missionType = document.getElementById("missionText");
    missionType.classList.add("d-none");
    const missionBtn = document.getElementById("missionBtn");
    missionBtn.classList.remove("cardDopColor");
}
function visionBtn() {
    const globalType = document.getElementById("globalText");
    globalType.classList.add("d-none");
    const globalBtn = document.getElementById("globalBtn");
    globalBtn.classList.remove("cardDopColor");

    const visionType = document.getElementById("visionText");
    visionType.classList.remove("d-none");
    const visionBtn = document.getElementById("visionBtn");
    visionBtn.classList.add("cardDopColor");
...
function missionBtn() {
    ...
    const missionType = document.getElementById("missionText");
    missionType.classList.remove("d-none");

    const missionBtn = document.getElementById("missionBtn");
    missionBtn.classList.add("cardDopColor");
}